...
subtitle: >-
  Developer podcast from a single place, a podcast player static site generated
...
I am Meet Gor and I present this project as a submission to the Netlify x Hashnode Hackathon. Podevcast is a webpage(static) for listening to podcasts centered around developers and programming. Just pick your favorite one and start listening straight away. Let's dive into the making of Podevcast. Head on to [https://podevcast.netlify.app/](https://podevcast.netlify.app/) to check out the live app.
