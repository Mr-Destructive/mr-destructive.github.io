...
subtitle: >-
  Using some shell tools and utilities to understand web scrapping and making a
  script to scrap a webpage.
status: published
slug: bash-dictionary-scrapper
image_url: >-
  https://cdn.hashnode.com/res/hashnode/image/upload/v1627367329063/dabJLKcD-.png?w=1600&h=840&fit=crop&crop=entropy&auto=compress
title: Scrapping the meaning of a word from dictionary.com using BASH script.
date: 2021-07-27T06:15:03.000Z
tags:
  - bash
---
