{"title":"Golang: File Reading","description":"Using system calls to read files in Golang. Reading files using various styles like line by line, word, character, chunk and any other specifc delimiter. Using os, bufio, io, encoding packages for helper funcitons making system calls.","status":"published","type":"posts","date":"2025-09-13","slug":"golang-file-read","tags":["go"],"image_url":"https://meetgor-cdn.pages.dev/golang-022-file-read.png","Extras":null}
