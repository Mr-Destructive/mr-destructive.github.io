{"title":"Configure Neovim in Lua","description":"Setting up or Migrating to Lua in Neovim Configuration. Using Lua in Neovim for configurations and moving out of Vimscript. Setting up Keymaps, Plugins, customizations","status":"published","type":"posts","date":"2025-09-13","slug":"neovim-vimscript-to-lua","tags":["vim","lua"],"image_url":"https://meetgor-cdn.pages.dev/vimtolua.png","Extras":null}
