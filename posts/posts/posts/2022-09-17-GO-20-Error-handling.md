{"title":"Golang: Error Handling","description":"Understanding the concept of errors in golang. How to handle errors in funciton calls, create custom error class with interfaces","status":"published","type":"posts","date":"2025-09-13","slug":"golang-error-handling","tags":["go"],"image_url":"https://meetgor-cdn.pages.dev/golang-020-error-handling.png","Extras":null}
