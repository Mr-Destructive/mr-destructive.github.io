{"series":["nginx-survival-guide"],"series_description":"NGINX Survival Guide: A Guide for Backend Developers, understanding the bare minimum fundamentals to get going with NGINX."}
